"""Components for the lecture-specific token analyzer page."""
...
def token_analyzer_exercise_selector() -> rx.Component:
    ...
    return analyzer_filter_selector(
        ...
        query_value=LectureTokenAnalyzerState.exercise_filter_query,
        on_query_change=LectureTokenAnalyzerState.set_exercise_filter_query,
        on_query_clear=LectureTokenAnalyzerState.clear_exercise_filter_query,
        options=LectureTokenAnalyzerState.displayed_filtered_exercise_options,
        selected_value=LectureTokenAnalyzerState.displayed_selected_exercise_name,
        on_select_change=LectureTokenAnalyzerState.set_selected_exercise_name,
    ...
    return rx.hstack(
        ...
        rx.menu.root(
            rx.menu.trigger(
                rx.button(
                    rx.cond(
                        LectureTokenAnalyzerState.active_analysis_view
                        == USER_ANALYSIS_VIEW,
            ...
            rx.menu.content(
                rx.menu.item(
                    LanguageState.user_stats,
                    on_click=LectureTokenAnalyzerState.set_active_analysis_view(
                        USER_ANALYSIS_VIEW
                    ),
                ),
                rx.menu.item(
...
def token_analyzer_user_selector() -> rx.Component:
    ...
    return analyzer_filter_selector(
        ...
        query_value=LectureTokenAnalyzerState.user_filter_query,
        on_query_change=LectureTokenAnalyzerState.set_user_filter_query,
        on_query_clear=LectureTokenAnalyzerState.clear_user_filter_query,
        options=LectureTokenAnalyzerState.displayed_filtered_user_options,
        selected_value=LectureTokenAnalyzerState.displayed_selected_user_name,
        on_select_change=LectureTokenAnalyzerState.set_selected_user_name,
        placeholder=LanguageState.all_option,
    )
...
def token_analyzer_user_bar_chart() -> rx.Component:
    ...
    return token_analyzer_rank_bar_chart(
        ticks=LectureTokenAnalyzerState.user_chart_ticks,
        rank_label=LanguageState.user_rank,
        metadata_key="username",
        metadata_label=LanguageState.user,
        value_color=rx.color("indigo", 8),
        value_bar_size=LectureTokenAnalyzerState.user_bar_size,
        chart_data=LectureTokenAnalyzerState.user_chart_data,
        chart_min_width=LectureTokenAnalyzerState.user_chart_min_width,
    )
...
def token_analyzer_exercise_bar_chart() -> rx.Component:
    ...
    return token_analyzer_rank_bar_chart(
        ticks=LectureTokenAnalyzerState.exercise_chart_ticks,
        ...
        value_bar_size=LectureTokenAnalyzerState.exercise_bar_size,
        chart_data=LectureTokenAnalyzerState.exercise_chart_data,
        chart_min_width=LectureTokenAnalyzerState.exercise_chart_min_width,
    )
...
def token_analyzer_user_table() -> rx.Component:
    ...
    return rx.table.root(
        ...
        rx.table.body(
            rx.foreach(
                LectureTokenAnalyzerState.user_table_rows,
                show_table_row,
            )
        ),
        variant="surface",
...
def token_analyzer_exercise_table() -> rx.Component:
    ...
    return rx.table.root(
        ...
        rx.table.body(
            rx.foreach(
                LectureTokenAnalyzerState.exercise_table_rows,
...
def token_analyzer_user_analysis_section() -> rx.Component:
    ...
    return rx.vstack(
        ...
        token_analyzer_total_tokens_info(LectureTokenAnalyzerState.total_user_tokens),
...
def token_analyzer_exercise_analysis_section() -> rx.Component:
    ...
    return rx.vstack(
        ...
        token_analyzer_total_tokens_info(
            LectureTokenAnalyzerState.total_exercise_tokens
        ),
