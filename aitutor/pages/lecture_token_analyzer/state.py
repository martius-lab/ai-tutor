"""State for the lecture-specific token analyzer page."""
...
class LectureTokenAnalyzerState(SessionState):
    ...
    def _user_may_view_token_analyzer(self, lecture_id: int) -> bool:
        """Return whether the current user may view token analyzer data."""
