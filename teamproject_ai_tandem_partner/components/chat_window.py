...
def chat_ui():  # noqa: D103
    return rx.container(
        ...
        rx.box(
            ...
            max_width="600px",  # Maximalbreite, um gleiche Abstände links und rechts sicherzustellen
        ...
        rx.scroll_area(
            rx.box(
                # Beispielnachrichten
                rx.text("Hallo! Wie kann ich dir helfen?", 
                        color="green", 
                        align="left",
                        padding="10px", 
                        margin="5px", 
                        ...
                        border_radius="5px"),
                rx.text("Ich möchte Deutsch lernen!", 
                        color="blue", 
                        align="right", 
                        padding="10px", 
                        margin="5px", 
